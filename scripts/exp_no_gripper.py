"""Experiment: Pure Vision Zone Identification (NO GRIPPER variant).
...
Gripper drawing and gripper_status field removed to test hallucination hypothesis.

Saves every prompt and raw response for post-hoc analysis.

Usage:
    python scripts/exp_no_gripper.py --runs 200 --output results.jsonl [--temperature 0.0] [--jpeg-quality 50] [--monochrome]
"""
